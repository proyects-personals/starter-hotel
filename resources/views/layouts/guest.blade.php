...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Escuela de mascotas') }}</title>
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-blue-50" 
             style="background-image: url('https://www.perrosguiaecuatorianos.org.ec/wp-content/uploads/2018/09/comoseentrenaindex3.jpg'); background-size: cover; background-position: center;">
