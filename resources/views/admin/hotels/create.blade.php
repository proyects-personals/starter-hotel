...
<body class="g-sidenav-show  bg-gray-100">
                ...
                <div class="col-md-12">
                    <div class="card shadow mb-4">
                        <div class="card-header py-4 text-center bg-info text-white">
                            <h1 class="mb-1">Registros de Hotel</h1>
                            <p class="mb-0">Completa el siguiente formulario para registrar un nuevo hotel</p>
                        </div>
                        <div class="card-body px-5">
                            <form action="{{ route('hotels.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <!-- Nombre del hotel -->
                                <div class="mb-4">
                                    <label for="name" class="form-label font-weight-bold text-dark" style="font-weight: bold; font-size: 18px;">Nombre del hotel</label>
                                    <input 
                                        type="text" 
                                        name="name" 
                                        id="name" 
                                        required 
                                        class="form-control border-2 border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500"
                                    >
                                    @error('name')
                                ...
                                <!-- Descripción -->
                                <div class="mb-4">
                                    <label for="description" class="form-label font-weight-bold text-dark" style="font-weight: bold; font-size: 18px;">Descripción</label>
                                    <textarea 
                                        name="description" 
                                        id="description" 
                                        rows="4" 
                                ...
                                <!-- Dirección -->
                                <div class="mb-4">
                                    <label for="address" class="form-label font-weight-bold text-dark" style="font-weight: bold; font-size: 18px;">Dirección</label>
                                    <input 
                                        type="text" 
                                        name="address" 
                                        id="address" 
                                ...
                                <!-- Teléfono -->
                                <div class="mb-4">
                                    <label for="phone_number" class="form-label font-weight-bold text-dark" style="font-weight: bold; font-size: 18px;">Teléfono</label>
                                    <input 
                                        type="text" 
                                        name="phone_number" 
                                        id="phone_number" 
                                ...
                                <!-- Correo electrónico -->
                                <div class="mb-4">
                                    <label for="email" class="form-label font-weight-bold text-dark" style="font-weight: bold; font-size: 18px;">Correo Electrónico</label>
                                    <input 
                                        type="email" 
                                        name="email" 
                                        id="email" 
                                ...
                                <!-- Imagen  -->
                                <div class="mb-4">
                                    <label for="image" class="form-label font-weight-bold text-dark" style="font-weight: bold; font-size: 18px;">Imagen</label>
                                    <input 
                                    type="file" 
                                    name="image" 
                                    id="image" 
                                    class="form-control-file border-2 border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500"
                                ...
                                <div class="mt-6 text-center">
                                    <button 
                                        type="submit" 
                                        class="btn btn-info btn-lg px-5 py-2 shadow-lg"
                                    >
                                        Registrar Hotel
                                    </button>
                                </div>
          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="card shadow mb-4">
                      ...
                      <div class="card-body px-5">
                          <form action="{{ route('hotels.store') }}" method="POST" enctype="multipart/form-data" id="hotelForm">
                              @csrf
                              ...
                              <div class="mb-4">                                   
                                ...
                                <input 
                                    ...
                                    title="Por favor ingresa un número válido de 7 o 10 dígitos" 
                                    required 
                                >                                   
                                @error('phone_number')                                       
                                <span class="text-danger text-sm mt-1">{{ $message }}</span>                                   
                              ...
                              <div class="mt-6 text-center">
                                  ...
                                  <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary btn-lg px-5 py-2 shadow-lg">
                                    Cancelar
                                </a>
                              </div>
                          </form>
  ...
  <!-- JavaScript para asegurar que no se envíe el formulario si algún campo está vacío -->
  <script>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h2 class="text-2xl font-medium mb-4">Configuracion del Hotel</h2>

                    <form action="{{ route('hotels.store') }}" method="POST" class="space-y-6">
                        @csrf
                        <!-- Nombre del hotel -->
                        <div>
                            <label for="name" class="block text-lg font-medium text-gray-700 dark:text-gray-300">Nombre del hotel</label>
                            <input 
                                type="text" 
                                name="name" 
                                id="name" 
                        ...
                        <div>
                            ...
                            >
                                Configurar informacion del hotel
                            </button>
                        </div>
                    </form>
                </div>
