                ...
                <div class="col-md-12">
                    <div class="card shadow mb-4">
                        <div class="card-header py-4 text-center bg-info text-white" >
                            ...
                            <h1 class="mb-1">Registros para Habitaciones</h1>
                            <p class="mb-0">Completa el siguiente formulario para agregar habitación</p>
                        </div>
                        <div class="card-body px-5">
                          <form action="{{ route('rooms.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf 
                                <!-- Hotel -->
                                <div>
                                    <label for="hotels_id" class="form-label text-dark" style="font-weight: bold; font-size: 18px;">Hotel</label>
                                ...
                                <!-- Descripcion -->
                                <div>
                                    <label for="name" class="form-label text-dark" style="font-weight: bold; font-size: 18px;">Nombre de la habitación</label>
                                    <input type="text" name="name" id="name" required class="form-control" />
                                </div>
        
                                <!-- Precio -->
                                <div>
                                  <label for="capacity" class="form-label text-dark" style="font-weight: bold; font-size: 18px;">Precio por noche</label>
                                  <input type="number" name="capacity" id="capacity" required class="form-control" step="0.01" />
                              </div>
                              
                                 <!-- Imagen  -->
                                <div class="mb-4">
                                  <label for="image" class="form-label font-weight-bold text-dark" style="font-weight: bold; font-size: 18px;">Subir imagen</label>
                                  <input 
                                  type="file" 
                                  name="image" 
                                  id="image" 
                                ...
                                <!-- Botón -->
                                <div class="mt-6">
                                    <button type="submit"  class="btn btn-info text-with">Crear habitacion </button>
                  ...
                  <div class="card shadow mb-4">
                      ...
                      <div class="card-body px-5">
                          <form action="{{ route('rooms.store') }}" method="POST" enctype="multipart/form-data" id="roomForm">
                              ...
                              <div>
                                <label for="capacity" class="form-label text-dark" style="font-weight: bold; font-size: 18px;">Precio por noche</label>
                                <input type="number" name="capacity" id="capacity" required class="form-control" step="0.01" min="0.01" />
                              </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h1 class="text-2xl font-semibold mb-6">Configurar Habitacion</h1>
                    ...
                    <form action="{{ route('rooms.store') }}" method="POST" class="space-y-6">
                        ...
                        <!-- Hotel -->
                        <div>
                            <label for="hotels_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Habitacion</label>
                            <select name="hotels_id" id="hotels_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
                                @foreach($hotels as $hotel)
                                    <option value="{{ $hotel->id }}">{{ $hotel->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <!-- Descripcion -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Descripcion</label>
                        ...
                        <!-- Precio -->
                        <div>
                            <label for="capacity" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Precio</label>
